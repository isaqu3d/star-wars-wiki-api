...
async function seed() {
    ...
    const planetsInsert = await database_1.db
        .insert(schema_1.planets)
        .values([
        {
            name: "Tatooine",
            rotation_period: "23",
        ...
        .returning();
    const charactersInsert = await database_1.db
        .insert(schema_1.characters)
        .values([
        {
            name: "Luke Skywalker",
            height: "172",
        ...
        .returning();
    const vehiclesInsert = await database_1.db
        ...
        .returning();
    const starshipsInsert = await database_1.db
        .insert(schema_1.starships)
        .values([
        {
            name: "CR90 corvette",
            model: "CR90 corvette",
        ...
        .returning();
    const filmsInsert = await database_1.db
        .insert(schema_1.films)
        .values([
        {
            title: "A New Hope",
            episode_id: 4,
        ...
        .returning();
    await database_1.db.insert(schema_1.character_vehicles).values([
